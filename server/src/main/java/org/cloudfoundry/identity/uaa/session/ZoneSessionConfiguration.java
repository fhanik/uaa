 ...
 * Not loaded when servlet.session-store=servlet (container default session, e.g. for unit tests).
 */
@Configuration
@ConditionalOnProperty(name = "servlet.session-store", havingValue = "memory")
