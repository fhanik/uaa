...
public class RemoteAuthenticationEndpoint {
    ...
    @PostMapping({"/authenticate", "/authenticate/", "/z/{subdomain}/authenticate", "/z/{subdomain}/authenticate/"})
    @ResponseBody
    ...
    @PostMapping(value = {"/authenticate", "/authenticate/", "/z/{subdomain}/authenticate", "/z/{subdomain}/authenticate/"}, params = {"source", "origin", UaaAuthenticationDetails.ADD_NEW})
    @ResponseBody
    public HttpEntity<AuthenticationResponse> authenticate(HttpServletRequest request,
            @RequestParam String username,
