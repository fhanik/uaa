...
public class ZoneNamespacedSessionRepository implements SessionRepository<Session> {
    ...
    public     static void setPreviousSessionId(HttpServletRequest request, String sessionId) {
    ...
    public static class MapSession implements Session {
        ...
        /**
         * No-op so one JSESSIONID cookie holds all zone sessions (session fixation would
         * break browse-back in path-based zones). Zone isolation provides mitigation.
         */
        @Override
