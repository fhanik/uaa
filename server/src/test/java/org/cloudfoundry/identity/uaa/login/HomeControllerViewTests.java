...
class HomeControllerViewTests extends TestClassNullifier {
    ...
    void handleRequestRejected() {
        assertThat(homeController.handleRequestRejected(mock(Model.class), mock(jakarta.servlet.http.HttpServletRequest.class), new RequestRejectedException(""), "")).isEqualTo("external_auth_error");
    }
