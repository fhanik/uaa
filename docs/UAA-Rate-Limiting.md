...
| pathSelectors             | List of "pathSelector" (Required, the list must contain at least one "pathSelector")                                                                                                                                                                                                                                            | ["equals:/oauth/token", "startsWith:/Users", "pathPattern:/api/**"] | The field specifies the set of UAA endpoints that this "limiterMapping" targets. See documentations of "pathSelector" below                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| pathPattern:PATTERN | "pathPattern:/Users/*", "pathPattern:/api/**" | PATTERN must start with a slash '/' and be a valid Spring path pattern. | The rate limit will apply if the request path matches the pattern. Uses `PathPatternParser` (e.g. `*` one segment, `**` zero or more segments, `{id}` path variable). |
